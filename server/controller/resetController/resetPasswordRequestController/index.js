...
const Unit = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const resetLink = `${url}/reset/password/token/${requestToken}`;
